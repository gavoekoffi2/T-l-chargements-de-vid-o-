...
CLIPS=[
 ("br_confused",   "confused_ia",      3.0,"glitch",  "VAGUE = NULS"),
 ("br_vague_type", "typing_vague",     3.0,"slide_l", "MAUVAIS PROMPT"),
 ("br_no_result",  "no_results",       3.0,"punch",   "0% RESULTAT"),
 ("br_ia_power",   "ia_power",         3.2,"flash",   "PUISSANCE IA"),
 ("br_context",    "context_notes",    3.0,"rise",    "DU CONTEXTE"),
 ("br_lightbulb",  "lightbulb_moment", 3.0,"flash",   "IDEE !"),
 ("br_job",        "job_posting",      3.0,"slide_r", "TROUVER UN EMPLOI"),
 ("br_lettre",     "lettre_motivation",3.2,"rise",    "LETTRE DE MOTIV."),
 ("br_good_prompt","good_prompt_typing",3.0,"punch",  "BON PROMPT"),
 ("br_ia_result",  "ia_great_result",  3.0,"flash",   "TOP RESULTAT"),
 ("br_eng",        "prompt_engineer",  3.2,"glitch",  "PROMPT ENG."),
 ("br_futur",      "futur_machine",    3.0,"rise",    "LE FUTUR"),
 ("br_discipline", "discipline_learn", 3.0,"slide_r", "A MAITRISER"),
 ("br_success",    "success_career",   3.0,"punch",   "SUCCES"),
 ("br_creator",    "subscribe_content",3.0,"slide_l", "ABONNE-TOI"),
 ("br_host",       "host_presenter",   3.2,"punch",   "TON FORMATEUR"),
]

if __name__=="__main__":
    only=sys.argv[1:] if len(sys.argv)>1 else None
    print("Animation B-roll IA/Prompt Engineering...")
