#!/usr/bin/env python3
"""Transcribe the trimmed audio with word-level timestamps."""
import json
from pathlib import Path
from faster_whisper import WhisperModel

ROOT = Path(__file__).resolve().parent.parent
AUDIO = ROOT / "downloads" / "audio2_trimmed.wav"
OUT = ROOT / "downloads" / "transcript2.json"
...
segments, info = model.transcribe(
    ...
    beam_size=5,
    vad_filter=False,  # already silence-trimmed
)
