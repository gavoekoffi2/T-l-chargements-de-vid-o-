...
CLIPS=[
 ("br_immigrants","immigrants",3.0,"slide_r","IMMIGRANTS"),
 ("br_tired","tired_work",2.8,"rise","ÉPUISÉ ?"),
 ("br_bills","bills",2.8,"glitch","LES FACTURES"),
 ("br_taxes","taxes",2.8,"slide_l","PRÉLEVÉ"),
 ("br_home","success_home",3.0,"punch","SA MAISON"),
 ("br_university","university",2.8,"slide_r","UNIVERSITÉ"),
 ("br_freedom","freedom_family","3.0","flash","LIBERTÉ"),
 ("br_advisor","advisor",3.0,"punch","TON CONTACT"),
]
